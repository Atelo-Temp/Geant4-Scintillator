    ...
    public:
        ...
        */
        std::optional<TH1*> replot(int const nbins, double const xmin, double const xmax, bool const doPostProcessing = false) {
            ...
            // ...
            std::optional<TH1*> const success = plot_root(lastPath, lastObjectName, lastBranchName, nbins, xmin, xmax, true, doPostProcessing);
...
int plot_x(
    ...
    if (fileType == FileType::ASCII) {
        ...
        result = gROOTHandler->plot_root(path, objectName, branchName, nbins, xmin, xmax, useCached, doPostProcessing);
    }
    else {
