...
int oop_discriminator() {
    ...
    std::cout << "\nTo fit the plotted histogram, call fit(arg1, arg2), passing curly brackets containing all centroids to fit as arg1 and an estimated fwhm integer as arg2.\n";
    std::cout << "\n-----------------------------------------------------------------------\n";
